const styles = {
  ...
  userAddressLabel:
    "h-[fit-content] bg-siteDimBlack text-siteWhite items-center flex rounded-md py-[5px] px-[10px]",
  ...
  gameLoadPlayerText:
    "mt-3 font-rajdhani text-white md:text-xl text-base tracking-wider",
